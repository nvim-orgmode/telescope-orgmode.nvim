...
describe('lib.highlights', function()
  describe('get_todo_highlight', function()
  ...
  describe('get_level_highlight', function()
  ...
  describe('get_priority_highlight', function()
  ...
  describe('get_headline_segments', function()
